...
We can do a query on the *RegioS* subtable to try to find the code that is used for the municipality Amstelveen. We see in *Table4* that we will have to use key 'GM0362'. 
